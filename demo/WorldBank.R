...
##
## To tun this demo an internet connection and Flash are required.
...
getWorldBankData <- function(id='SP.POP.TOTL', date='1960:2010', value="value", per.page=12000){
  ...
  wbData = data.frame(
    ...
    value = as.numeric(sapply(wbData, function(x) ifelse(is.null(x[["value"]]),NA, x[["value"]]))), 
...
GDP.per.capita <- getWorldBankData(id='NY.GDP.PCAP.CD',
                                   date='1960:2010', value="GDP.per.capita.Current.USD")
