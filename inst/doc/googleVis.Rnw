...
detail in the help pages. Here we will cover only the principals of
the package.
...
M$chartid
@ 
The html output list is than split into header, chart, caption and
...
e.g. your web server repository, than you can set the arguments for 
