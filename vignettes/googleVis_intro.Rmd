...
output with the `r BiocStyle::CRANpkg("R.rsp")` package [@Rsp]. 
...
`r BiocStyle::CRANpkg("googleVis")` package 
...
objects, using the `r BiocStyle::CRANpkg("jsonlite")` package [@jsonlite], as
...
optional list, which we discuss in more detail in section
\@ref(settingoptions). The options and data requirements
...
The plot method for `gvis`-objects creates HTML files in a temporary folder using
...
[Shiny](https://www.rstudio.com/shiny/) is a package by
...
Using googleVis with [knitr](https://yihui.name/knitr/) [@knitr] is a
...
stackoverflow.com:
 ...
 1. Go to https://www.adobe.com/support/documentation/en/flashplayer/help/settings_manager04.html
...
Visualisation API newsgroup](https://groups.google.com/group/google-visualization-api).
