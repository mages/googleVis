...
supported by most browsers. An alternative is `plotly::ggplotly`. For more see [https://plotly-r.com/animating-views.html](https://plotly-r.com/animating-views.html)
