...
not submitted to any server\footnote{\url{https://developers.google.com/chart/interactive/docs/gallery/motionchart.html\#Data\_Policy}}. 
...
\href{https://stackoverflow.com/questions/8009825/cannot-view-gvismotionchart-from-printed-html-file 
}{stackoverflow.com}: 

\begin{enumerate}\label{breyal}
\item Go to \url{https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager04.html}
...
describes the label of the browser button\footnote{See also
  \url{https://developers.google.com/chart/interactive/docs/drawing\_charts\#charteditor}}. 
<<eval=FALSE>>=
...
\href{https://wordpress.org/}{WordPress} is a popular web software for
...
plugin\footnote{\url{https://wordpress.org/extend/plugins/custom-fields-shortcode}}. 
...
Gadget technology from \href{https://en.wikipedia.org/wiki/Google_Gadgets}{Wikipedia}.
\begin{verbatim}
...
\texttt{https://example.com/myGadget.xml}, than you can embed  the gadget
...
\item in a Google Code wiki via the \texttt{wiki:gadget} tag, e.g.: 
  ...
  \texttt{<wiki:gadget url="https://example.com/gadget.xml" />},
...
src="https://example.com/myGoogleVisChart.html">
</iframe>
\end{verbatim}
For an example see the following blog entry:
\href{https://magesblog.com/post/2011-09-11-including-googlevis-output-in-a-blogger-post/}
{https://magesblog.com/post/2011-09-11-including-googlevis-output-in-a-blogger-post/}.
...
project site: 
\href{https://rapache.net/manual.html}{https://\-rapache.\-net/\-manual\-.html},
for specific comments on Mac OS X see: 
\href{https://worldofrcraft.blogspot.com/2010/08/installing-rapache-on-mac-os-x-snow.html}{https://\-worldofrcraft\-.blog\-spot\-.com/\-2010/\-08/\-installing\--rapache\--on\--mac\--os\--x\--snow\-.html}  
...
the \rapache site:
\href{https://biostat.mc.vanderbilt.edu/rapache/files/RApacheInfo.html}{https://\-biostat.\-mc.\-vanderbilt.\-edu/\-rapache/\-files/\-RApacheInfo\-.html} 
...
Shiny\footnote{\url{https://www.rstudio.com/shiny/}} is a package by
...
\knitr\footnote{\url{https://yihui.name/knitr/}}~\cite{knitr} is a
...
\url{https://magesblog.com/post/2012-05-15-interactive-reports-in-r-with-knitr-and/}
...
\href{https://skp.mvps.org/liveweb.htm}{liveweb} provides the
...
\begin{figure}[h]
  ...
  \caption{\googleVis tutorial at the useR! 2013 conference: \url{https://decastillo.github.io/googleVis_Tutorial}} 
  \label{fig:slidify}
\end{figure}
...
events~\footnote{\url{https://developers.google.com/chart/interactive/docs/events}}. 
...
support page for more details: \url{https://support.google.com/fusiontables/answer/2679986?hl=en}
...
\url{https://groups.google.com/group/google-visualization-api}.
