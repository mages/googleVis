...
gvisWelcomeMessage <- function(){
  ...
  paste("To suppress the following message use the statement:\n",
        ...
        "\n",
       "Before you use this package read the Google Visualisation API Terms of Use:\n",
       "http://code.google.com/apis/visualization/terms.html, and for charts\n",
        "using geo locations the Google Maps API Terms of Service:\n",
